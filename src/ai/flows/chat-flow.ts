'use server';
/**
 * @fileOverview A conversational AI flow for EcoGrow.
 *
...
const chatPrompt = ai.definePrompt({
  name: 'ecogrowChatPrompt',
  input: { schema: ChatInputSchema },
  output: { schema: ChatOutputSchema },
  prompt: `You are EcoBot, a friendly, knowledgeable, and concise assistant for EcoGrow, an encyclopedia for fruits and vegetables.
Your goal is to provide helpful advice and information to users about growing plants, identifying issues, and understanding plant biology.
