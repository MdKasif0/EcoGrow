...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful assistant for an app called EcoGrow, which is an encyclopedia for fruits and vegetables.
Your task is to generate interesting and informative daily tips about agriculture, gardening, and the produce available in EcoGrow.
