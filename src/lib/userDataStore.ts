...
// Original constants
const FAVORITES_KEY = 'ecogrow-favorites';
const RECENT_SEARCHES_KEY = 'ecogrow-recent-searches';
const GEMINI_API_KEY_STORAGE_KEY = 'ecogrow-gemini-api-key';
const MAX_RECENT_SEARCHES = 5;
const USER_MODE_KEY = 'ecogrow-user-mode';
